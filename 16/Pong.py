...
class Game(arcade.Window):
    def __init__(self):
        ...
        self.player_1 = Racket(40,self.height//2,arcade.color.BLUE,"Nadiya")
        self.player_2 = Racket(self.width - 40,self.height//2,arcade.color.BLUE,"Ehsan")
        self.ball = Ball(self)
    def on_draw(self):
        arcade.start_render()
        arcade.draw_rectangle_outline(self.width//2,self.height//2,self.width-30,self.height-30,arcade.color.BABY_BLUE,border_width=10)
        arcade.draw_line(self.width//2,30,self.width//2,self.height-30,color = arcade.color.BABY_BLUE,line_width=10)
        self.player_1.draw()
        self.player_2.draw()
        self.ball.draw()
